...
w_L2 = weights_L2[test_no]
w_L3 = weights_L3[test_no]
print(x)
...
for j in range(len(w_L2)):
	w_L2_bi.append( [prob_int_to_bipolar(i) for i in w_L2] )

# L3 weights
w_L3_bi = []
for j in range(len(w_L3)):
	w_L3_bi.append( [prob_int_to_bipolar(i) for i in w_L3] )

bias_bi = prob_int_to_bipolar(bias_test)
...
L2_out = []
for i in range(8):
	result_bi = Neuron(x_bi, w_bi, bias_bi)
	L2_out.append(result_bi)
