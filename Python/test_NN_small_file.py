...
def Neuron(inputs, weights, bias):
	...
	#print("mul = ", [bipolar_to_prob_int(k) for k in mul])

	# Sum pairs and /2
	add_1 = [ (mul[i*2]+mul[(i*2)+1])/2 for i in range(4) ]
	add_2 = [ (add_1[i*2]+add_1[(i*2)+1])/2 for i in range(2) ]
	add_3 = (add_2[0] + add_2[1])/2
	#print("add1 = ", [bipolar_to_prob_int(k) for k in add_1])
	#print("add2 = ", [bipolar_to_prob_int(k) for k in add_2])
	...
	#print("Result: ", bipolar_to_prob_int(result))
...
# Biases
biases_L2 = [127, 127, 127, 127, 127, 127, 127, 127]
biases_L3 = [52, 227, 110, 11, 39]


# Run 100 tests
with open("NN_python_data.txt", "w+") as f:
	for test_no in range(100):
		...
		# print L2 outputs
		#print("L2_out: ", [bipolar_to_prob_int(k) for k in L2_results])
		...
		f.write( f"Test: {test_no+1}, Results: {unipolar_to_int(L3_results[0])}, {unipolar_to_int(L3_results[1])}, \
{unipolar_to_int(L3_results[2])}, {unipolar_to_int(L3_results[3])}, {unipolar_to_int(L3_results[4])}\n" )